...
<section> 
        ...
        <!-- Dia 1 --> 
        <div id="dia1"> 
            <p class="prono5">Clima</p>
                <div class="app-title pronos"> 
                </div>
                <div class="weather-container1">
                    <div id="fechafore" class="fechafore"></div>
                    <div id="clima1" class="weather-icon1"> 
                            <img src="icons/unknown.png" alt=""> 
                         </div>
                    <div id="temperature-value1">
        ...
        <div id="dia2"> 
            ...
            <div class="app-title pronos">
                ...
                <div class="weather-container1">
                    <div id="fechafore2" class="fechafore"></div>
                    <div id="clima2" class="weather-icon1"> 
                            <img src="icons/unknown.png" alt=""> 
                         </div>
                    <div id="temperature-value2" >
        ...
        <div id="dia3"> 
            <p class="prono5">Clima</p>
                ...
                <div class="weather-container1">
                    <div id="fechafore3" class="fechafore"></div>
                    <div id="clima3" class="weather-icon1"> 
                            <img src="icons/unknown.png" alt=""> 
                         </div>
                    <div id="temperature-value3">
        ...
        <div id="dia4"> 
            <p class="prono5">Clima</p>
                ...
                <div class="weather-container1">
                    <div id="fechafore4" class="fechafore"></div>
                    <div id="clima4" class="weather-icon1"> 
                            <img src="icons/unknown.png" alt=""> 
                         </div>
                    <div id="temperature-value4">
        ...
        <div id="dia5"> 
            <p class="prono5">Clima</p>
                ...
                <div class="weather-container1">
                    <div id="fechafore5" class="fechafore"></div>
                    <div id="clima5" class="weather-icon1"> 
                            <img src="icons/unknown.png" alt=""> 
                         </div>
                    <div id="temperature-value5">
...
>>>>>>> 3b249386779a1d19af9fc825766be06ddbd53f6e:Weather/index.html
