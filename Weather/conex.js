$(document).ready(function(){
  $.ajax({
      ...
      success: function(respuesta) {
        ...
        $('#weather1').html(respuesta.list[0].weather[0].description + "<br>"+ "<br>");
...
$(document).ready(function(){
  $.ajax({
      ...
      success: function(respuesta) {
        ...
        $('#weather2').html(respuesta.list[4].weather[0].description + "<br>"+ "<br>");
...
$(document).ready(function(){
  $.ajax({
      ...
      success: function(respuesta) {
        ...
        $('#weather3').html(respuesta.list[12].weather[0].description + "<br>"+ "<br>");
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success: function(respuesta) {
          ...
          $('#weather4').html(respuesta.list[20].weather[0].description + "<br>"+ "<br>");
...
$.ajax({
    ...
    success: function(respuesta) {
      ...
      $('#weather5').html(respuesta.list[20].weather[0].description + "<br>"+ "<br>");
